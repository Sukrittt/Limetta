          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-x-4 relative">
              ...
              <div className="flex flex-col gap-y-2 pl-16">
                ...
                <p className="text-muted-foreground">
                  Our due date tracking ensures you never miss a payment,
                  whether it&rsquo;s your friend&rsquo;s &rsquo;borrowed&rsquo;
                  cash or your monthly bills. Say goodbye to late fees and hello
