            ...
            <div className="flex gap-x-4 relative">
              ...
              <div className="flex flex-col gap-y-2 pl-16">
                ...
                <p className="text-muted-foreground">
                  ...
                  goals. Stay organized by tracking transactions in each
                  account, providing a clear overview of your financial
                  landscape.
                </p>
              </div>
            </div>
            <div className="flex gap-x-4 relative">
              ...
              <div className="flex flex-col gap-y-2 pl-16">
                ...
                <p className="text-muted-foreground">
                  ...
                  accounts. Whether you&rsquo;re logging expenses, investments,
                  or savings, our user-friendly interface ensures you stay in
                  control of your finances with simplicity and precision.
                </p>
              </div>
            </div>
          </div>
